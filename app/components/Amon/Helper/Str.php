...
class Str
{
    ...
    final public static function camelize($string, $delimiter = '_')
    {
        if (empty($delimiter)) {
    ...
    final public static function lowerCamelizeWithDelimiter($string, $delimiter = '', $useLow = false)
    {
        if (empty($string)) {
    ...
    final public static function lowerCamelize($string)
    {

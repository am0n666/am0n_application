...
class DateHelper
{
	 ...
	 * @return string
	 */
	final public static function now($withTime = true): string
	{
	 ...
	 * @return string
	 */
	final public static function reformat(string $date, string $format = self::FORMAT_DATETIME)
	{
	 ...
	 * @param string $date			
	 */
	final public static function isEmpty(string $date): bool
	{
	 ...
	 * @return string
	 */
	final public static function addDays(int $days, ?string $date = null, string $format = self::FORMAT_DATETIME): string
	{
	 ...
	 * @return string
	 */
	final public static function addHours(int $hours, ?string $date = null, string $format = self::FORMAT_DATETIME): string
	{
		$curDate = new \DateTime($date);
	 ...
	 * @return string
	 */
	final public static function addMinutes(int $minutes, ?string $date = null, string $format = self::FORMAT_DATETIME): string
	{
		$curDate = new \DateTime($date);
	 ...
	 * @return string
	 */
	final public static function addSeconds(int $seconds, ?string $date = null, string $format = self::FORMAT_DATETIME): string
	{
		$curDate = new \DateTime($date);
	 ...
	 * @return string
	 */
	final public static function subSeconds(int $seconds, ?string $date = null, string $format = self::FORMAT_DATETIME): string
	{
		$curDate = new \DateTime($date);
	 ...
	 * @return int
	 */
	final public static function secondsUntil(string $date): int
	{
	 ...
	 * @return int
	 */
	final public static function secondsSince(string $date): int
	{
	 ...
	 * @return string
	 */
	final public static function extractTime(string $date, string $format = self::FORMAT_TIME): string
	{
	 ...
	 * @return string
	 */
	final public static function extractDate(string $date, string $format = self::FORMAT_DATE): string
	{
		return (new \DateTime($date))->format($format);
	}
}
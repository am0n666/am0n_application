...
class ClassLoader
{
    ...
    protected $classes=[];
    protected $classes_without_namespaces=[];
    protected $files=[];
	...
	protected function get_class_name( $class, $without_namespace = true ) {
    ...
    protected function loadFile($file, $class)
    {
        ...
        if ($this->isLoaded($class)) {
			$this->classes_without_namespaces[] = $this->get_class_name($class);
			$this->classes[] = $class;
			$this->files[] = $file;
    ...
    public function getClassesWithoutNamespaces(bool $as_object = false)
    {
		($as_object)? $result = Other::toObject($this->classes_without_namespaces): $result = $this->classes_without_namespaces;
        return $result;
    }
